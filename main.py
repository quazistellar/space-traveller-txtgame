         ...
         while True:
            ...
            while True:
                ...
                if txt7 == "да":
                    ...
                    print_with_typing("- Вобщем, друзья, будем признательны, если вы вытащите нас отсюда, следующий портал только через три дня..")
            ...
            if score<30:
                ...
                print_with_typing(f"Необходимо собрать 30, сейчас у Вас их {score}")

        print("\n=== >>> Продолжение приключения <<< ===")
        if not should_continue():
            break
        elif selected_location == "стоп":
            end_game()
